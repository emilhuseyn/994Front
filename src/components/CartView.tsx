...
export default function CartView() {
  ...
  // without a deploy.  Falls back to 150 ₼.
            ...
            <dl className="mt-5 grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <dd className="mt-1 text-lg font-semibold">
                  {format(placedOrder.totalAmount)}
                </dd>
              </div>
              <div>
                <dt className="text-[11px] uppercase tracking-wider text-neutral-500">
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-sm font-medium sm:hidden">
                        {t('cart.col.total')}: {format(lineTotal)}
                      </p>
                      <button
                        onClick={() =>
                          withBusy(key, () =>
